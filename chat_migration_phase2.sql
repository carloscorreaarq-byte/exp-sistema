-- =====================================================================
-- EXP Chat - Phase 2 hardening
-- Run after chat_migration.sql
-- Covers:
-- - channel-aware RLS for general, socios, dm and group
-- - socios role aliases (socio, socio_adm, socio_admin)
-- - atomic reaction toggle via RPC
-- - removal of broad direct UPDATE on chat_messages
-- =====================================================================
